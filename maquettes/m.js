...
(function () {
  ...
  var pages = [['a-nuit-cafe', 'A', 'Nuit café'], ['b-bento', 'B', 'Bento'], ['c-editorial', 'C', 'Éditorial'], ['d-connecte', 'D', 'Connecté'], ['e-affiche', 'E', 'Affiche'], ['f-immersif', 'F', 'Immersif'], ['g-distributeur', 'G', 'Distributeur'], ['h-sommaire', 'H', 'Sommaire'], ['i-planche', 'I', 'Planche'], ['j-enseigne', 'J', 'Enseigne'], ['k-epure', 'K', 'Épure']];
